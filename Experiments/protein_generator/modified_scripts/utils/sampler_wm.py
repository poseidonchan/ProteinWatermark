...
class SEQDIFF_sampler:
    ...
    def setup(self, init_model=True):
        ...
        self.features['seq_diffused'] = diff_utils_wm.mask_inputs(self.features['seq_hot'],
        ...
        # get alphas
        self.features['alpha'], self.features['alpha_t'] = diff_utils_wm.get_alphas(self.features['t1d'], self.features['xyz_t'], 
    ...
    def predict_x(self):
        ...
        = diff_utils_wm.take_step_nostate(self.model,
...
class cleavage_foldswitch_SAMPLER(SEQDIFF_sampler):
    ...
    def setup(self, init_model=True):
        ...
        self.features['alpha'], self.features['alpha_t'] = diff_utils_wm.get_alphas(self.features['t1d'], self.features['xyz_t'],
                                                                                 self.features['B'], self.features['L'],
                                                                                 self.ti_dev, self.ti_flip, self.ang_ref)
        self.features['a_alpha'], self.features['a_alpha_t'] = diff_utils_wm.get_alphas(self.features['a_t1d'], self.features['a_xyz_t'],
                                                                                 self.features['a_B'], self.features['a_L'],
                                                                                 self.ti_dev, self.ti_flip, self.ang_ref)
        self.features['b_alpha'], self.features['b_alpha_t'] = diff_utils_wm.get_alphas(self.features['b_t1d'], self.features['b_xyz_t'],
...
class grad_test_SAMPLER(SEQDIFF_sampler):
    ...
    def predict_x(self):
        ...
        self.features['pair_prev'], \
        self.features['state_prev'] \
        = diff_utils_wm.take_step_nostate_grads(self.model,
        self.features['msa_masked'],
        self.features['msa_full'],
        self.features['seq'],
        self.features['t1d'],
